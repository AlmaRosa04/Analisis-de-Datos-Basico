...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 24-03-2025 a las 01:34:10
...
(3, 'George Orwell', 'Britanico', '1903-03-25');
...
(2, 'Lucia Fernanez', 'Avenida Sol, 456', '987654321');
...
ALTER TABLE `prestamo`
  ...
  ADD CONSTRAINT `prestamo_ibfk_2` FOREIGN KEY (`ID_Libro`) REFERENCES `libros` (`ID_Libro`);

--
-- Filtros para la tabla `prestamos_usuarios`
--
ALTER TABLE `prestamos_usuarios`
  ADD CONSTRAINT `prestamos_usuarios_ibfk_1` FOREIGN KEY (`ID_Prestamo`) REFERENCES `prestamo` (`ID_Prestamo`),
